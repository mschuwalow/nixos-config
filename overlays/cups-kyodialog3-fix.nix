...
in {
  cups-kyodialog3 = super.cups-kyodialog3.overrideAttrs (oldAttrs: rec {
    src = super.fetchzip {
      url =
        "https://la.kyoceradocumentsolutions.com/content/dam/kdc/kdag/downloads/technical/executables/drivers/kyoceradocumentsolutions/lad/en/Kyocera_Linux_PPD_Ver_${oldAttrs.version}.tar.gz";
